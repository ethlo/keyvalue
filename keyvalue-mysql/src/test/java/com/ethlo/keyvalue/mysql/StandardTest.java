...
public class StandardTest extends KeyValueDbTest
{
    @Autowired
    private MysqlClientManagerImpl<CasKeyValueDb<ByteArrayKey, byte[], Long>> mysqlClientManager;

    @Override
    protected CasKeyValueDb<ByteArrayKey, byte[], Long> getCasDb()
    {
